      ...
      <div class="personal-order">
        ...
        <el-form :inline="true">
          <el-form-item label="就诊人：">
            <el-select v-model="searchObj.patientName" placeholder="请选择就诊人" class="v-select patient-select">
              <el-option
...
export default {
  ...
  methods: {
    fetchData(page = 1) {
      this.page = page
      orderInfo.list(this.page, this.limit, this.searchObj).then(response => {
    ...
    findPatientList() {
      patient.findPatientList()
        .then(response => {
        this.patientList = response.data
      })
    },
    getStatusList() {
      orderInfo.getAuthStatusList()
        .then(response => {
